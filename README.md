...
This was probably the toughest challenge I've attempted yet.

I ran into some issues near the end of my code when it came to the scatter plot and correlation and regression. I kept getting a "KeyError" for 'Weight (g)'. Unfortunately, I ran out of time troubleshooting and will have to turn in my code as is. Below are some of the resources I used for this assignment. Most notably near the end of my code.
